...
func (j *BotCommand) MarshalJSON() ([]byte, error) {
...
func (j *BotCommand) MarshalJSONBuf(buf fflib.EncodingBuffer) error {
	if j == nil {
		buf.WriteString("null")
		return nil
	}
	...
	fflib.WriteJsonString(buf, string(j.Command))
...
const (
	ffjtBotCommandbase = iota
	ffjtBotCommandnosuchkey

	ffjtBotCommandCommand

	ffjtBotCommandDescription
)

var ffjKeyBotCommandCommand = []byte("command")

var ffjKeyBotCommandDescription = []byte("description")

// UnmarshalJSON umarshall json - template of ffjson
func (j *BotCommand) UnmarshalJSON(input []byte) error {
	fs := fflib.NewFFLexer(input)
	return j.UnmarshalJSONFFLexer(fs, fflib.FFParse_map_start)
}

// UnmarshalJSONFFLexer fast json unmarshall - template ffjson
func (j *BotCommand) UnmarshalJSONFFLexer(fs *fflib.FFLexer, state fflib.FFParseState) error {
	var err error
	currentKey := ffjtBotCommandbase
	_ = currentKey
...
mainparse:
	for {
		...
		case fflib.FFParse_want_key:
			...
			if len(kn) <= 0 {
				// "" case. hrm.
				currentKey = ffjtBotCommandnosuchkey
				...
				case 'c':
					...
					if bytes.Equal(ffjKeyBotCommandCommand, kn) {
						currentKey = ffjtBotCommandCommand
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'd':
					...
					if bytes.Equal(ffjKeyBotCommandDescription, kn) {
						currentKey = ffjtBotCommandDescription
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				if fflib.EqualFoldRight(ffjKeyBotCommandDescription, kn) {
					currentKey = ffjtBotCommandDescription
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.SimpleLetterEqualFold(ffjKeyBotCommandCommand, kn) {
					currentKey = ffjtBotCommandCommand
					state = fflib.FFParse_want_colon
					goto mainparse
				}
		...
		case fflib.FFParse_want_value:
			...
			if tok == fflib.FFTok_left_brace || tok == fflib.FFTok_left_bracket || tok == fflib.FFTok_integer || tok == fflib.FFTok_double || tok == fflib.FFTok_string || tok == fflib.FFTok_bool || tok == fflib.FFTok_null {
				...
				case ffjtBotCommandCommand:
					goto handle_Command

				case ffjtBotCommandDescription:
					goto handle_Description

				case ffjtBotCommandnosuchkey:
...
handle_Command:
	...
	/* handler: j.Command type=string kind=string quoted=false*/

	{
		...
		if tok == fflib.FFTok_null {
			...
			j.Command = string(string(outBuf))
...
// MarshalJSON marshal bytes to json - template
func (j *BotCommandScope) MarshalJSON() ([]byte, error) {
	var buf fflib.Buffer
	if j == nil {
		buf.WriteString("null")
		return buf.Bytes(), nil
...
// MarshalJSONBuf marshal buff to json - template
func (j *BotCommandScope) MarshalJSONBuf(buf fflib.EncodingBuffer) error {
	if j == nil {
		buf.WriteString("null")
		return nil
	}
	...
	/* Interface types must use runtime reflection. type=model.CommandScope kind=interface */
...
const (
	ffjtBotCommandScopebase = iota
	ffjtBotCommandScopenosuchkey

	ffjtBotCommandScopeType

	ffjtBotCommandScopeChatID

	ffjtBotCommandScopeUserID
)

var ffjKeyBotCommandScopeType = []byte("type")

var ffjKeyBotCommandScopeChatID = []byte("chat_id")

var ffjKeyBotCommandScopeUserID = []byte("user_id")

// UnmarshalJSON umarshall json - template of ffjson
func (j *BotCommandScope) UnmarshalJSON(input []byte) error {
	fs := fflib.NewFFLexer(input)
	return j.UnmarshalJSONFFLexer(fs, fflib.FFParse_map_start)
}

// UnmarshalJSONFFLexer fast json unmarshall - template ffjson
func (j *BotCommandScope) UnmarshalJSONFFLexer(fs *fflib.FFLexer, state fflib.FFParseState) error {
	var err error
	currentKey := ffjtBotCommandScopebase
	_ = currentKey
	tok := fflib.FFTok_init
	wantedTok := fflib.FFTok_init
...
mainparse:
	for {
		...
		case fflib.FFParse_want_key:
			...
			if len(kn) <= 0 {
				// "" case. hrm.
				currentKey = ffjtBotCommandScopenosuchkey
				state = fflib.FFParse_want_colon
				goto mainparse
			} else {
				switch kn[0] {
				...
				case 'c':
					...
					if bytes.Equal(ffjKeyBotCommandScopeChatID, kn) {
						currentKey = ffjtBotCommandScopeChatID
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 't':
					...
					if bytes.Equal(ffjKeyBotCommandScopeType, kn) {
						currentKey = ffjtBotCommandScopeType
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'u':
					...
					if bytes.Equal(ffjKeyBotCommandScopeUserID, kn) {
						currentKey = ffjtBotCommandScopeUserID
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				if fflib.EqualFoldRight(ffjKeyBotCommandScopeUserID, kn) {
					currentKey = ffjtBotCommandScopeUserID
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.AsciiEqualFold(ffjKeyBotCommandScopeChatID, kn) {
					currentKey = ffjtBotCommandScopeChatID
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.SimpleLetterEqualFold(ffjKeyBotCommandScopeType, kn) {
					currentKey = ffjtBotCommandScopeType
					state = fflib.FFParse_want_colon
					goto mainparse
				}
		...
		case fflib.FFParse_want_value:
			...
			if tok == fflib.FFTok_left_brace || tok == fflib.FFTok_left_bracket || tok == fflib.FFTok_integer || tok == fflib.FFTok_double || tok == fflib.FFTok_string || tok == fflib.FFTok_bool || tok == fflib.FFTok_null {
				...
				case ffjtBotCommandScopeType:
					goto handle_Type

				case ffjtBotCommandScopeChatID:
					goto handle_ChatID

				case ffjtBotCommandScopeUserID:
					goto handle_UserID

				case ffjtBotCommandScopenosuchkey:
					err = fs.SkipField(tok)
					if err != nil {
						return fs.WrapErr(err)
					}
...
handle_Type:
	...
	/* handler: j.Type type=model.CommandScope kind=interface quoted=false*/

	{
		/* Falling back. type=model.CommandScope kind=interface */
...
// MarshalJSON marshal bytes to json - template
func (j *MyCommands) MarshalJSON() ([]byte, error) {
	var buf fflib.Buffer
	if j == nil {
		buf.WriteString("null")
		return buf.Bytes(), nil
...
// MarshalJSONBuf marshal buff to json - template
func (j *MyCommands) MarshalJSONBuf(buf fflib.EncodingBuffer) error {
	if j == nil {
		buf.WriteString("null")
		return nil
	}
...
const (
	ffjtMyCommandsbase = iota
	ffjtMyCommandsnosuchkey

	ffjtMyCommandsScope

	ffjtMyCommandsLanguageCode
)

var ffjKeyMyCommandsScope = []byte("scope")

var ffjKeyMyCommandsLanguageCode = []byte("language_code")

// UnmarshalJSON umarshall json - template of ffjson
func (j *MyCommands) UnmarshalJSON(input []byte) error {
	fs := fflib.NewFFLexer(input)
	return j.UnmarshalJSONFFLexer(fs, fflib.FFParse_map_start)
}

// UnmarshalJSONFFLexer fast json unmarshall - template ffjson
func (j *MyCommands) UnmarshalJSONFFLexer(fs *fflib.FFLexer, state fflib.FFParseState) error {
	var err error
	currentKey := ffjtMyCommandsbase
	_ = currentKey
	tok := fflib.FFTok_init
	wantedTok := fflib.FFTok_init
...
mainparse:
	for {
		...
		case fflib.FFParse_want_key:
			...
			if len(kn) <= 0 {
				// "" case. hrm.
				currentKey = ffjtMyCommandsnosuchkey
				state = fflib.FFParse_want_colon
				goto mainparse
			} else {
				switch kn[0] {
				...
				case 'l':
					...
					if bytes.Equal(ffjKeyMyCommandsLanguageCode, kn) {
						currentKey = ffjtMyCommandsLanguageCode
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 's':
					...
					if bytes.Equal(ffjKeyMyCommandsScope, kn) {
						currentKey = ffjtMyCommandsScope
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				if fflib.AsciiEqualFold(ffjKeyMyCommandsLanguageCode, kn) {
					currentKey = ffjtMyCommandsLanguageCode
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeyMyCommandsScope, kn) {
					currentKey = ffjtMyCommandsScope
					state = fflib.FFParse_want_colon
					goto mainparse
				}
		...
		case fflib.FFParse_want_value:
			...
			if tok == fflib.FFTok_left_brace || tok == fflib.FFTok_left_bracket || tok == fflib.FFTok_integer || tok == fflib.FFTok_double || tok == fflib.FFTok_string || tok == fflib.FFTok_bool || tok == fflib.FFTok_null {
				...
				case ffjtMyCommandsScope:
					goto handle_Scope

				case ffjtMyCommandsLanguageCode:
					goto handle_LanguageCode

				case ffjtMyCommandsnosuchkey:
					err = fs.SkipField(tok)
					if err != nil {
						return fs.WrapErr(err)
					}
...
handle_Scope:
	...
	/* handler: j.Scope type=model.BotCommandScope kind=struct quoted=false*/
...
func (j *SendChatActionRequest) MarshalJSONBuf(buf fflib.EncodingBuffer) error {
	...
	/* Interface types must use runtime reflection. type=model.ChatAction kind=interface */
...
handle_Action:
	...
	/* handler: j.Action type=model.ChatAction kind=interface quoted=false*/

	{
		/* Falling back. type=model.ChatAction kind=interface */
		tbuf, err := fs.CaptureField(tok)
		if err != nil {
			return fs.WrapErr(err)
		}
...
func (j *SendPollRequest) MarshalJSONBuf(buf fflib.EncodingBuffer) error {
	...
	if j.Type != nil {
		buf.WriteString(`"type":`)
		/* Interface types must use runtime reflection. type=model.PollType kind=interface */
		err = buf.Encode(j.Type)
		if err != nil {
			return err
		}
...
handle_Type:
	...
	/* handler: j.Type type=model.PollType kind=interface quoted=false*/

	{
		/* Falling back. type=model.PollType kind=interface */
		tbuf, err := fs.CaptureField(tok)
		if err != nil {
			return fs.WrapErr(err)
		}
...
// MarshalJSON marshal bytes to json - template
func (j *SetMyCommands) MarshalJSON() ([]byte, error) {
	var buf fflib.Buffer
	if j == nil {
		buf.WriteString("null")
		return buf.Bytes(), nil
...
// MarshalJSONBuf marshal buff to json - template
func (j *SetMyCommands) MarshalJSONBuf(buf fflib.EncodingBuffer) error {
	if j == nil {
		buf.WriteString("null")
		return nil
	}
...
const (
	ffjtSetMyCommandsbase = iota
	ffjtSetMyCommandsnosuchkey

	ffjtSetMyCommandsCommands

	ffjtSetMyCommandsScope

	ffjtSetMyCommandsLanguageCode
)

var ffjKeySetMyCommandsCommands = []byte("commands")

var ffjKeySetMyCommandsScope = []byte("scope")

var ffjKeySetMyCommandsLanguageCode = []byte("language_code")

// UnmarshalJSON umarshall json - template of ffjson
func (j *SetMyCommands) UnmarshalJSON(input []byte) error {
	fs := fflib.NewFFLexer(input)
	return j.UnmarshalJSONFFLexer(fs, fflib.FFParse_map_start)
}

// UnmarshalJSONFFLexer fast json unmarshall - template ffjson
func (j *SetMyCommands) UnmarshalJSONFFLexer(fs *fflib.FFLexer, state fflib.FFParseState) error {
	var err error
	currentKey := ffjtSetMyCommandsbase
	_ = currentKey
	tok := fflib.FFTok_init
	wantedTok := fflib.FFTok_init
...
mainparse:
	for {
		...
		case fflib.FFParse_want_key:
			...
			if len(kn) <= 0 {
				// "" case. hrm.
				currentKey = ffjtSetMyCommandsnosuchkey
				state = fflib.FFParse_want_colon
				goto mainparse
			} else {
				switch kn[0] {
				...
				case 'c':
					...
					if bytes.Equal(ffjKeySetMyCommandsCommands, kn) {
						currentKey = ffjtSetMyCommandsCommands
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 'l':
					...
					if bytes.Equal(ffjKeySetMyCommandsLanguageCode, kn) {
						currentKey = ffjtSetMyCommandsLanguageCode
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				case 's':
					...
					if bytes.Equal(ffjKeySetMyCommandsScope, kn) {
						currentKey = ffjtSetMyCommandsScope
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				if fflib.AsciiEqualFold(ffjKeySetMyCommandsLanguageCode, kn) {
					currentKey = ffjtSetMyCommandsLanguageCode
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeySetMyCommandsScope, kn) {
					currentKey = ffjtSetMyCommandsScope
					state = fflib.FFParse_want_colon
					goto mainparse
				}

				if fflib.EqualFoldRight(ffjKeySetMyCommandsCommands, kn) {
					currentKey = ffjtSetMyCommandsCommands
					state = fflib.FFParse_want_colon
					goto mainparse
				}
		...
		case fflib.FFParse_want_value:
			...
			if tok == fflib.FFTok_left_brace || tok == fflib.FFTok_left_bracket || tok == fflib.FFTok_integer || tok == fflib.FFTok_double || tok == fflib.FFTok_string || tok == fflib.FFTok_bool || tok == fflib.FFTok_null {
				...
				case ffjtSetMyCommandsCommands:
					goto handle_Commands

				case ffjtSetMyCommandsScope:
					goto handle_Scope

				case ffjtSetMyCommandsLanguageCode:
					goto handle_LanguageCode

				case ffjtSetMyCommandsnosuchkey:
					err = fs.SkipField(tok)
					if err != nil {
						return fs.WrapErr(err)
					}
...
handle_Commands:
	...
	/* handler: j.Commands type=[]*model.BotCommand kind=slice quoted=false*/

	{
		...
		if tok == fflib.FFTok_null {
			...
			j.Commands = []*BotCommand{}

			wantVal := true

			for {

				var tmpJCommands *BotCommand
				...
				/* handler: tmpJCommands type=*model.BotCommand kind=ptr quoted=false*/

				{
					if tok == fflib.FFTok_null {
						...
						if tmpJCommands == nil {
							tmpJCommands = new(BotCommand)
						}

						err = tmpJCommands.UnmarshalJSONFFLexer(fs, fflib.FFParse_want_key)
						if err != nil {
							return err
						}
					}
				...
				j.Commands = append(j.Commands, tmpJCommands)
